      ...
      <div className="flex min-h-full items-start justify-center sm:items-center">
        <div className="my-3 flex max-h-[94dvh] w-full max-w-[980px] flex-col rounded-[14px] border border-[var(--border-disabled)] bg-[var(--background-white)] px-3 py-3 shadow-[0_18px_55px_rgba(15,23,42,0.2)] sm:my-0 sm:px-6 sm:py-6">
          ...
          <div className="flex-1 space-y-4 overflow-y-auto pr-0 sm:pr-1">
            ...
            {errors.title?.message ? (
              <p className="text-xs text-[var(--button-warning)]">{errors.title.message}</p>
            ) : null}
            ...
            <div className="space-y-3">
              ...
              {canAddOption ? (
                <button
                  ...
                  className="inline-flex cursor-pointer items-center gap-2 text-xl font-normal leading-[30px] text-[var(--button-primary)] transition-opacity hover:opacity-80"
                >
              ...
              {optionErrorMessage ? (
                <p className="text-xs text-[var(--button-warning)]">{optionErrorMessage}</p>
              ) : null}
            </div>
          )}
        </div>
        ...
        <div className="mt-4 flex flex-col-reverse gap-3 border-t border-[var(--border-disabled)] pt-4 sm:mt-5 sm:flex-row sm:items-center sm:justify-end sm:pt-5">
          ...
          <Button
            ...
            className="h-12 w-full rounded-xl bg-[var(--button-primary)] px-6 text-lg font-normal text-[var(--button-white)] hover:opacity-95 sm:min-w-[180px] sm:w-auto sm:text-xl"
          >
            <span className="inline-flex items-center gap-2">
              {isSubmitting ? <Spinner className="h-4 w-4" /> : null}

...
export function ManageOnlineTestHeader({ step = "basic", backDisabled = false }) {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl rounded-[14px] border border-[var(--border-disabled)] bg-[var(--background-white)] p-4 sm:p-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-5">
          <h1 className="text-xl font-medium leading-normal text-[var(--text-primary)]">
            Manage Online Test
          </h1>
